...
NUM_BLOCKS = 12
DROPOUT = 0.1					# GPT: 0.1		Nano: 0.0
USE_BIAS = True					# GPT: True		Nano: False
INIT_STDDEV = 0.02

STEP_PER_EPOCH = 500
VAL_STEPS = int(STEP_PER_EPOCH * VAL_RATIO)
BATCH_SIZE = 32					# GPT: 64		Nano: 32
NUM_EPOCHS = 1000
MAX_LEARNING_RATE = 2.5e-4		# GPT: 2.5e-4	Nano: 6e-4
MIN_LEARNING_RATE = 1e-5		# GPT: 0.0		Nano: 6e-5
INCREASE_STEPS = 2000
DECAY_EPOCHS = NUM_EPOCHS
WEIGHT_DECAY = 0.01
BETA_1 = 0.9					# GPT: 0.9		Nano: 0.9
BETA_2 = 0.999					# GPT: 0.999	Nano: 0.95
CLIP_GRADIENTS = 1.0
